  ...
  <section class="rates container">
    ...
    <table class="rates__list">
      <?php foreach ($bets as $b): 
        ...
        //$classname_fin = ((setTime1(date('Y-m-d H:i:s'), $b['data_stop'])) == 'Время истекло') ? "rates__item--end" : "";
        //$classname_now = ((setTime1(date('Y-m-d H:i:s'), $b['data_stop'])) != 'Время истекло') ? "timer--finishing" : "";
        ?>
