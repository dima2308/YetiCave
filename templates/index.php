            ...
            <ul class="promo__list">
                <?php foreach ($categories as $cat): ?>
                    <li class="promo__item promo__item--<?=$cat['cat_img'];?>">
                        <a class="promo__link" href="all-lot?category=<?=$cat['cat_name'];?>"><?=$cat['cat_name'];?></a>
                    </li> 
                 <?php endforeach; ?>
            </ul>
</section>
          ...
          <ul class="lots__list">
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="lot<?php print('?' . 'num' . '=' . $value['id']);?>"><?php print($value['name']); ?></a></h3>
        ...
        <ul class="pagination-list">
              ...
              <?php
                for ($i = 1; $i <= $total; $i++){ ?>
                    ...
                    <li class="pagination-item <?= $active; ?>"><a href="index?page=<?=$i;?>"><?= $i; ?></a></li>
                <?php } ?>
