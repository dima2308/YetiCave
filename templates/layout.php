...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo" href="index?page=1">
        ...
        <a class="main-header__add-lot button" href="all_bets">Мои ставки</a>
        <?php } ?>
        <nav class="user-menu">
			<?php  
                if (isset($_SESSION['user'])) { ?>
                    <div class="user-wrap">
                        <div class="user-menu--image">
                            <img src="<?php if ($template_data['avatar'] == 'img/avatars/')
                                    print('img/avatars/unknown.jpg');
                                    else print($template_data['avatar']);?>" width="40" height="40" alt="Пользователь">
                        </div>
                        <div class="user-menu--logged">
                            <p> <?php print("->" . $template_data['username']) ?></p>
                        </div>
                    </div>
						<a class="user-menu--exit" href="logout">Выход</a>
...
<main class="container">
        <?php print($template_data['content']); ?>
</main>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            <?php
            foreach ($template_data['categories'] as $value) {
    ...
    <div class="main-footer__bottom container">
        ...
        <div class="main-footer__social social">
            ...
            <a class="social__link social__link--facebook" href="https://www.facebook.com/">Facebook
      ...
      ,</span>
            <a class="social__link social__link--twitter" href="https://twitter.com/">Twitter
      ...
      ,</span>
            <a class="social__link social__link--instagram" href="https://www.instagram.com/">Instagram
            ...
            <a class="social__link social__link--vkontakte" href="https://vk.com/feed">Вконтакте
